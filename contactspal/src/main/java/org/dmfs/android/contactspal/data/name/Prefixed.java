...
public final class Prefixed implements StructuredNameData
{
    ...
    public Prefixed(@Nullable CharSequence prefix)
    {
        this(prefix, EmptyNameData.INSTANCE);
    }


    public Prefixed(@Nullable CharSequence prefix, @NonNull StructuredNameData delegate)
    {
        mDelegate = delegate;
        mPrefix = prefix;
    }
