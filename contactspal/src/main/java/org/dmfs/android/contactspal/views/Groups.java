...
/**
 * The ContactsProvider {@link ContactsContract.Groups} {@link View}.
 */
public final class Groups extends DelegatingView<ContactsContract.Groups>
{
    public Groups(@NonNull ContentProviderClient client)
    {
        super(new BaseView<>(client, ContactsContract.Groups.CONTENT_URI));
    }
}
