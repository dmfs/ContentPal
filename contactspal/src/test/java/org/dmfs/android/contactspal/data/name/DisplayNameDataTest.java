...
public class DisplayNameDataTest
{
    @Test
    public void test()
    {
        assertThat(
            ...
            builds(
                withValuesOnly(
                    ...
                    containing(ContactsContract.CommonDataKinds.StructuredName.DISPLAY_NAME, "John Doe")
                )
            )
        );

        assertThat(
            new DisplayNameData(null),
            builds(
                withValuesOnly(
                    containing(ContactsContract.Data.MIMETYPE, ContactsContract.CommonDataKinds.StructuredName.CONTENT_ITEM_TYPE),
                    containing(ContactsContract.CommonDataKinds.StructuredName.DISPLAY_NAME, nullValue())
                )
            )
        );
    }
