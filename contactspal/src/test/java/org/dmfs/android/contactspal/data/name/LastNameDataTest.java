...
public class LastNameDataTest
{
    @Test
    public void test()
    {
        assertThat(
            new LastNameData("Doe"),
            builds(
                withValuesOnly(
        ...
        assertThat(
            new LastNameData(null),
            builds(
                withValuesOnly(
                    containing(ContactsContract.Data.MIMETYPE, ContactsContract.CommonDataKinds.StructuredName.CONTENT_ITEM_TYPE),
                    containing(ContactsContract.CommonDataKinds.StructuredName.FAMILY_NAME, nullValue())
                )
            )
        );
    }
