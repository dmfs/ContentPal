...
public class FirstNameDataTest
{
    @Test
    public void test()
    {
        assertThat(
            new FirstNameData("John"),
            builds(
                withValuesOnly(
        ...
        assertThat(
            new FirstNameData(null),
            builds(
                withValuesOnly(
                    containing(ContactsContract.Data.MIMETYPE, ContactsContract.CommonDataKinds.StructuredName.CONTENT_ITEM_TYPE),
                    containing(ContactsContract.CommonDataKinds.StructuredName.GIVEN_NAME, nullValue())
                )
            )
        );
    }
