...
public class RawInsertTest
{
    ...
    {
        assertThat(new RawInsert<>(mock(Uri.class, new FailAnswer())).reference(), isAbsent((SoftRowReference<Object>) mock(SoftRowReference.class)));
    }
    ...
    {
        assertThat(new RawInsert<>(mock(Uri.class, new FailAnswer())),
                builds(
                        insertOperation(),
                        withYieldNotAllowed(),
