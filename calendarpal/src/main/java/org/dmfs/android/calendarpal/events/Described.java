...
/**
 * Decorator to add a description to an event.
 *
 * @author Marten Gajda
 */
public final class Described implements RowData<CalendarContract.Events>
{
    ...
    public Described(@Nullable CharSequence description)
    {
        this(description, EmptyRowData.<CalendarContract.Events>instance());
    }
