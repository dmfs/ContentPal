...
public final class PredicateMatcherTest
{
    ...
    public void testEmptyArguments()
    {
        assertTrue(emptyArguments().matches(
            when(mock(Predicate.class).arguments(any(TransactionContext.class))).thenReturn(emptyIterable()).getMock()));
        ...
        assertTrue(emptyArguments(dummyTc).matches(
            when(mock(Predicate.class).arguments(dummyTc)).thenReturn(emptyIterable()).getMock()));
